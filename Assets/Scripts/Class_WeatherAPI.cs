...
public class Class_WeatherAPI: MonoBehaviour
{
    public GameObject weatherTextObject1;
    string url = "https://api.openweathermap.org/data/2.5/weather?lat=1.351&lon=103.8198&APPID=9f95ea2da5bbf9415740de1b86c23ebd&units=Metric";
    ...
    IEnumerator GetRequest(string uri)
    {
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
                ...
                weatherTextObject1.GetComponent<TextMeshPro>().text = "" + easyTempF.ToString() + "°C\n" + conditions;
            }
        }
    }
}